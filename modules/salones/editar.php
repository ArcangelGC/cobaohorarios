<?php
// modules/salones/editar.php - Editar salón existente (SIN DISPONIBILIDAD)
session_start();
...
$sql_salon = "SELECT * FROM salones WHERE id = ? AND activo = 1";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nombre)) {
        ...
        $sql_verificar = "SELECT id FROM salones WHERE nombre = ? AND id != ?";
        $existe = obtenerRegistro($sql_verificar, [$nombre, $id]);
        
        if ($existe) {
            $mensaje = 'Ya existe otro salón con ese nombre';
            $tipo_mensaje = 'danger';
        } else {
            $sql = "UPDATE salones SET 
                    ...
                    ubicacion = ? 
                    WHERE id = ?";
            $params = [$nombre, $tipo, $capacidad, $ubicacion, $id];
            $types = "ssisi";
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="mb-0">Editar Salón</h5>
                            <small>Modifica los datos del salón <strong><?php echo htmlspecialchars($salon['nombre']); ?></strong></small>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <span class="value"><?php echo $salon['id']; ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="nombre" name="nombre" 
                                           value="<?php echo htmlspecialchars($salon['nombre']); ?>"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="capacidad" name="capacidad" 
                                           value="<?php echo $salon['capacidad']; ?>" min="1" max="100">
                                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-3 col-sm-6">
                                <div class="tipo-card <?php echo $salon['tipo'] == 'aula' ? 'selected' : ''; ?>" onclick="seleccionarTipo('aula')">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="tipo-card <?php echo $salon['tipo'] == 'laboratorio' ? 'selected' : ''; ?>" onclick="seleccionarTipo('laboratorio')">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="tipo-card <?php echo $salon['tipo'] == 'taller' ? 'selected' : ''; ?>" onclick="seleccionarTipo('taller')">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="tipo-card <?php echo $salon['tipo'] == 'auditorio' ? 'selected' : ''; ?>" onclick="seleccionarTipo('auditorio')">
                                    <span class="tipo-icon"><i class="fas fa-microphone"></i></span>
                                    <div class="tipo-nombre">Auditorio</div>
                                    <div class="tipo-desc">Eventos</div>
                                </div>
                            </div>
                            <input type="hidden" id="tipo" name="tipo" value="<?php echo $salon['tipo']; ?>">
                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="ubicacion" name="ubicacion" 
                                           value="<?php echo htmlspecialchars($salon['ubicacion']); ?>"
